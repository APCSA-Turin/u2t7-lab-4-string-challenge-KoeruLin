...
public class StringProblems
{
  ...
  public boolean endsLy(String x)
  {
      ...
      return x.substring(length - 2).equals("ly");
  }
  ...
  public String conCat(String s1, String s2)
  {
    ...
    else if (s1.substring(length - 1).equals(s2.substring(0, 1)))
    {
  ...
  public String deFont(String s1)
  {
      ...
      {
        return firstChar + s1.substring(2);
      }
  ...
  {
    int length = s1.length();
    String string1 = s1.substring(0, 1);
    String string2 = s1.substring(length - 1);
    if (string1.equals("x") && string2.equals("x"))
    {
